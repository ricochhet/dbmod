...
.PHONY: $(APP_NAME)
$(APP_NAME): $(APP_NAME)-linux $(APP_NAME)-linux-arm64 $(APP_NAME)-darwin $(APP_NAME)-darwin-arm64 $(APP_NAME)-windows

.PHONY: $(APP_NAME)-linux
$(APP_NAME)-linux: fmt
	$(call GO_BUILD_APP,linux,amd64,$(APP_NAME)-linux,$(APP_PATH))

.PHONY: $(APP_NAME)-linux-arm64
$(APP_NAME)-linux-arm64: fmt
	$(call GO_BUILD_APP,linux,arm64,$(APP_NAME)-linux-arm64,$(APP_PATH))

.PHONY: $(APP_NAME)-darwin
$(APP_NAME)-darwin: fmt
	$(call GO_BUILD_APP,darwin,amd64,$(APP_NAME)-darwin,$(APP_PATH))

.PHONY: $(APP_NAME)-darwin-arm64
$(APP_NAME)-darwin-arm64: fmt
